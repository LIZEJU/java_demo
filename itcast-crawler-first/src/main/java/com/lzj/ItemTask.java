...
//            this.parseHtml(html);
    ...
    private void store() {
        ...
        item.setSku(skuId);
        //商品url地址
        item.setUrl("https://item.jd.com/" + 1 + ".html");
        //创建时间
        ...
        //获取商品价格
        String priceUrl = "https://p.3.cn/prices/mgets?skuIds=J_"+1;
//        String priceJson = this.httpUtils.getHtml(priceUrl);
        ...
        //获取图片地址
        String pic = "https://www.baidu.com/1.jpg";
